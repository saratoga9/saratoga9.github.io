...
DATA.people = {
    ...
    tbd: { name: 'TBD' },
    pray1: { name: 'Sister ʻOfa Fifita' },
    pray2: { name: 'Brother Kaleo Teriipaia' },
...
DATA.cheatSheet = {
    ...
    sacrament: {
        ...
        speakers: [
            ...
            // } as Speaker,
            {
                person: { name: 'Brother Colin Martin' },
                role: 'speaker',
                index: 1,
                beforeRestHymn: true,
            },
            {
                person: { name: 'Sister Allana Teriipaia ' },
                role: 'speaker',
                index: 1,
                beforeRestHymn: true,
            },
