...
DATA.people = {
    ...
    tbd: { name: 'TBD' },
    pray1: { name: 'Brother Sione Bloomfield' },
    pray2: { name: 'Sister Vea Manumaleuna' },
...
DATA.hymns = {
    ...
    84: {
        ...
        page: 84,
        link: 'https://www.churchofjesuschrist.org/music/library/hymns/faith-of-our-fathers?lang=eng',
    },
    85: {
    ...
    113: {
        title: 'Po Malu',
        page: 113,
        link: 'https://www.churchofjesuschrist.org/music/library/hymns/silent-night?lang=ton',
    },
    116: {
    ...
    130: {
        ...
        page: 130,
        link: 'https://www.churchofjesuschrist.org/music/library/hymns/be-thou-humble?lang=eng',
    },
    131: {
    ...
    // 134: {
    //   title: 'Teke lava fakaha',
    //   page: 134,
    //   link:
    //     'https://www.churchofjesuschrist.org/music/text/hymns/you-can-make-the-pathway-bright?lang=ton',
    // },
    134: {
    ...
    300: {
        ...
        page: 300,
        link: 'https://www.churchofjesuschrist.org/music/library/hymns/families-can-be-together-forever?lang=eng',
    },
    302: {
    ...
    500: {
        title: 'Oh lord, my redeemer',
        page: 500,
        link: 'https://ldslyrics.livejournal.com/3550.html',
    },
};
DATA.releases = [
    // {
...
DATA.cheatSheet = {
    ...
    sacrament: {
        ...
        restSong: DATA.hymns[500],
        testimonySunday: false,
        speakers: [
            {
                person: { name: 'Les Halafuka - Relief Society President' },
                role: 'speaker',
                index: 1,
                beforeRestHymn: true,
            },
            {
                person: { name: 'Erick Funn - Sunday School President' },
                role: 'speaker',
                index: 1,
                beforeRestHymn: true,
            },
            {
                person: { name: 'Gabe Toki - Elders Quorum President' },
                role: 'speaker',
                index: 1,
                beforeRestHymn: true,
            },
            {
                person: { name: 'Alipate Prescott - Executive Secretary' },
                role: 'speaker',
                index: 1,
                beforeRestHymn: false,
            },
            {
                person: { name: 'Wayne Tarawhiti - Bishop' },
                role: 'speaker',
                index: 1,
                beforeRestHymn: false,
            },
            {
                person: {
                    name: 'Darren Harris - 1st Counselor to the Stake President',
                },
                role: 'speaker',
                index: 1,
                beforeRestHymn: false,
