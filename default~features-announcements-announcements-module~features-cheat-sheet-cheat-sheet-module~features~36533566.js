...
DATA.announcements = [
    ...
    },
    {
        ...
        date: new Date(2022, 5, 23).toUTCString(),
...
DATA.people = {
    ...
    tbd: { name: 'TBD' },
    pray1: { name: 'Sister Jena Vasquez' },
    pray2: { name: 'Brother Raymond Terrell' },
